...
public class MainCore2 {
	...
	private static int normalExecution(ArrayList<Item> elements, int[] repetition, int MaxWeight) throws WrongInputsException {
		return KnapsackCore2.knapSack(elements, repetition,MaxWeight, TEST_MODE);
	}
	...
	private static void runTimePlot() throws WrongInputsException{
		...
		for(int i = 0; i < NUMBER_OF_PLOTS; i++) {
		    ...
		    fillList(elements, repetition, aux);//I fill the list
	 ...
	 */
	@SuppressWarnings("unused")
	private static long lessReliableTime(ArrayList<Item> elements, int[] repetition) throws WrongInputsException{
	 ...
	 */
	@SuppressWarnings("unused")
	private static long moreReliableTime(ArrayList<Item> elements, int[] repetition) throws WrongInputsException{
